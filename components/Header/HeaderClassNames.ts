const headerClassNames = {
    ...
    cart : "absolute inline-flex items-center justify-center w-6 h-6 text-xs font-bold text-white bg-primary border-2 borfer-white rounded-full -top-2 -right-2",
    ...
    logoutBtn :
    "bg-blue-500 ml-4 flex hover:bg-blue-700 text-white font-bold py-2 px-2 rounded",
};
