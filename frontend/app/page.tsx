  ...
  return (
    ...
    <>
      ...
      <section
        style={{
          backgroundImage:
            "url('/https://images.unsplash.com/photo-1592155931584-901ac15763e3?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60')",
        }}
      ...
      >
        <div className={styles.categoryContent}>
          ...
          <p className={styles.categorySubHeading}>
            ...
            worlds, compete with friends, and become a champion.
          </p>
      ...
      <section id="recent-games" className={recentGamesClasses.section}>
        ...
        <p className={recentGamesClasses.subHeading}>
          Stay Ahead of the Gaming Curve with the Latest Games.
        </p>
...
//   description:
//     "Immerse yourself in a vast fantasy realm where epic battles and strategic conquests",
